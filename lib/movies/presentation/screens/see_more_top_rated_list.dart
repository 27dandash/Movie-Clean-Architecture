...
class SeeMoreeTopRateList extends StatelessWidget {
  final int movieId;

  const SeeMoreeTopRateList({super.key, required this.movieId});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailBloc>()
        ..add(GetMovieDetailEvent(movieId))
        ..add(GetMovieRecomnendationEvent(movieId)),
      lazy: false,
